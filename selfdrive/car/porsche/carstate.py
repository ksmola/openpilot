...
from selfdrive.car.porsche.values import CAR, DBC, STEER_THRESHOLD, NO_STOP_TIMER_CAR, TSS2_CAR
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if (self.CP.carFingerprint not in TSS2_CAR and self.CP.carFingerprint) or \
